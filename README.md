...
Autogenerated documentation: [DeepWiki](https://deepwiki.com/borzacchiello/bhex)
...
- Execute template files using a custom language, located in the `templates/` subdirectory.
