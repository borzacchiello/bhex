// Generated from the reference implementation of GOST R 34.11-2012 by
// Alexey Degtyarev (2-clause BSD); see streebog.c for the notice.

// clang-format off
// The A-matrix multiplication, precomputed per byte position: this is the
// table of the reference implementation named above, in the form that reads
// the 512-bit value as eight little-endian words.
static const u64_t Ax[8][256] = {
    {
...
// The twelve round constants of GOST R 34.11-2012
static const u64_t C[12][8] = {
    {
