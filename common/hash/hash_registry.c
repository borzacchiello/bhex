...
// Sorted by name, case-insensitively, because that is the order "hh/l"
// lists them in and the order "hh *" reports them in. A new algorithm goes
...
static hash_handler_t hash_handlers[] = {
    ...
    {"skein-1024", handle_skein_1024_1024},
    {"skein-256", handle_skein_256_256},
    {"skein-512", handle_skein_512_512},
