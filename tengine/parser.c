...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_enum_list = 56,                 /* enum_list  */
  YYSYMBOL_stmts = 57,                     /* stmts  */
  YYSYMBOL_stmt = 58,                      /* stmt  */
  YYSYMBOL_fvar_type = 59,                 /* fvar_type  */
  YYSYMBOL_fvar_decl = 60,                 /* fvar_decl  */
  YYSYMBOL_lvar_decl = 61,                 /* lvar_decl  */
  YYSYMBOL_lvar_ass = 62,                  /* lvar_ass  */
  YYSYMBOL_void_fcall = 63,                /* void_fcall  */
  YYSYMBOL_if_elif = 64,                   /* if_elif  */
  YYSYMBOL_else = 65,                      /* else  */
  YYSYMBOL_while = 66,                     /* while  */
  YYSYMBOL_break = 67,                     /* break  */
  YYSYMBOL_expr = 68,                      /* expr  */
  YYSYMBOL_name_params = 69,               /* name_params  */
...
static const yytype_int16 yyrline[] =
{
     ...
     207,   210,   214,   222,   226,   233,   239,   245,   249,   255,
     259,   266,   273,   279,   284,   285,   288,   292,   297,   301,
     304,   308,   312,   315,   318,   321,   324,   327,   330,   333,
     336,   339,   342,   345,   348,   351,   354,   357,   360,   363,
     366,   371,   375,   379,   383,   388,   391,   394,   397,   400,
     403,   406,   409,   414
};
#endif
...
yysymbol_name (yysymbol_kind_t yysymbol)
{
  ...
  "TBNEQ", "TBGT", "TBGE", "TBLT", "TBLE", "TEQUAL", "TBNOT", "$accept",
  "program", "enum_list", "stmts", "stmt", "fvar_type", "fvar_decl",
  "lvar_decl", "lvar_ass", "void_fcall", "if_elif", "else", "while",
  "break", "expr", "name_params", "params", "num", "ident", YY_NULLPTR
  };
...
#line 2162 "parser.c"
  ...
  case 62: /* name_params: name_params TCOMMA ident  */
#line 375 "parser.y"
                                                    {
                                                        DList_add((yyval.params), (yyvsp[0].ident));
                                                    }
...
#line 2179 "parser.c"
  ...
  case 64: /* params: params TCOMMA expr  */
#line 383 "parser.y"
                                                    {
                                                        DList_add((yyval.params), (yyvsp[0].expr));
                                                    }
